    ...
    setTimeout(() => {
        $('#loadingContainer').fadeOut(250, () => {
            ...
            setOverlayContent(
                ...
                "Une connexion n'a pu être établie avec nos serveurs pour télécharger l'index de distribution. Aucune copie locale n'était disponible pour le chargement.<br><br>L'index de distribution est un fichier essentiel qui fournit les dernières informations sur le serveur. Le lanceur est incapable de démarrer sans lui. Assurez-vous que vous êtes connecté à l'Internet et relancez l'application.",
                'Fermer'
            )
            setOverlayHandler(() => {
